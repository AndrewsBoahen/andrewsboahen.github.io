...
- **Forward propagation** — using surrogate modelling and polynomial chaos expansions to push distributions through expensive simulators.
- **Sensitivity analysis** — via Sobol' indices and variance decompositions to identify which inputs drive output uncertainty, formally expressed as
...
**Topics:** polynomial chaos · Sobol' indices · Gaussian process emulation · rare event estimation · error propagation
